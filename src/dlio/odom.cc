...
dlio::OdomNode::OdomNode(ros::NodeHandle node_handle) : nh(node_handle) {
  ...
  // CZ and Claude
  this->original_scan_full = pcl::PointCloud<PointType>::ConstPtr (boost::make_shared<const pcl::PointCloud<PointType>>());
  this->deskewed_scan_full = pcl::PointCloud<PointType>::ConstPtr (boost::make_shared<const pcl::PointCloud<PointType>>());
...
void dlio::OdomNode::getScanFromROS(const sensor_msgs::PointCloud2ConstPtr& pc) {
  ...
  pcl::PointCloud<PointType>::Ptr original_scan_cropped_ (boost::make_shared<pcl::PointCloud<PointType>>());
...
void dlio::OdomNode::preprocessPoints() {
  ...
  if (this->deskew_) {
    ...
    pcl::PointCloud<PointType>::Ptr deskewed_scan_full_ (boost::make_shared<pcl::PointCloud<PointType>>());
...
void dlio::OdomNode::deskewPointcloud() {
  ...
  pcl::PointCloud<PointType>::Ptr deskewed_scan_ (boost::make_shared<pcl::PointCloud<PointType>>());
  deskewed_scan_->points.resize(this->original_scan_full->points.size()); // CZ and Claude: deskew the full (uncropped) scan
...
void dlio::OdomNode::splitDeskewedScan(const pcl::PointCloud<PointType>::Ptr& full_scan,
  ...
  pcl::PointCloud<PointType>::Ptr cropped_ (boost::make_shared<pcl::PointCloud<PointType>>());
